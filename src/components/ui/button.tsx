  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-warm text-primary-foreground shadow-lg hover:shadow-glow hover:scale-[1.02] font-semibold",
        cart: "bg-success text-success-foreground hover:bg-success/90 shadow-md",
        category: "bg-card text-card-foreground border border-border hover:border-primary hover:text-primary transition-colors",
        categoryActive: "bg-primary text-primary-foreground shadow-md",
      },
      size: {
